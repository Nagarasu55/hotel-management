...
var message=document.myform.message.value;
  ...
  if(name !==""&&phonenum !==""&&phonenum.length ==10&&email !==""&&email1.test(email)&&!isNaN(phonenum)&& message !==""){
    alert('Thank you for contact Hotel Grand Palace, Mr./Mrs.'+' '+document.getElementById("name").value+' '+', We will contact you soon.');
  }
